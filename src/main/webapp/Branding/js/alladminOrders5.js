				...
				if (listOrders != null){
					...
					$.each(listOrders, function(i, orderObj) {
						...
						+"<input type='hidden' id='appDate"+i+"' value='"+orderObj.appointmentDate+"'/>"
								...
								+"<li class='two-boxxx' >"+"<input type='text' name='invoicedateId' id='"+orderObj.orderId+"invoicedateId' value='"+orderObj.invoiceDate+"' class='invoicedateId' onclick='datpicker1()'>"+"</li>"
