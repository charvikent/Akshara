			...
			$.each(listOrders, function(i, orderObj) {
				...
				if(orderObj.statusName == 'Paid'){
					// closed =  "<li class='ten-boxxx ' id='"+orderObj.orderId+"2' >"+"<input type='button' id='"+orderObj.orderId+"1' value='invoice' onclick='formSubmit1(this.id)' ></li>"  
					 closed =  "<img alt='Image!'  id='"+orderObj.gid+"' onclick='formSubmit1(this.id)'   src='images/invoice.png' >"
					 vendorInvoice =  "<img alt='Image!'  id='"+orderObj.gid+"' onclick='vendorInvoice(this.id)'   src='images/invoice.png' >"
