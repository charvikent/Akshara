							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="blog">
									<div class="blog-header">
										<h5 class="blog-title">Login Form</h5>
									</div>
									<div class="blog-body">
										...
										<form id="login-form" action="LoginHome1" method="post" class="form-horizontal" role="form">
											<div class="form-group">
											    ...
											    <div class="col-lg-4 col-md-4 col-sm-8 col-sm-12">
											...
											<div class="form-group">
											    ...
											    <div class="col-lg-4 col-md-4 col-sm-8 col-sm-12">
													<input type="text" tabindex="2" class="form-control" placeholder="Enter Username" autocomplete="on" name="name" id="name" required/>
												</div>
											</div>
											<div class="form-group">
