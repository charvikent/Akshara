...
<script type="text/javascript">
	...
	function submitForm() {
		...
		var selectdayId=$('#dayId').val();
		selectdayId = JSON.stringify(selectdayId);
				...
				<c:if test="${empty servEdit}">
					<div class="block">
						...
						<form:form action="" commandName="packCmd" method="post"
							...
							<div class="block-box-small package-topbox block-box-top-header-dept" style= "height: 280px !important" >
								<div class="block-input">
									...
									<c:choose>
										<c:when
											test="${sessionScope.cacheUserBean.userName  eq  'admin' || sessionScope.cacheUserBean.userName  eq  'operation' }">
								...
								<label>Priority</label> 
									<select	id="priorityId" class="some-select">
										<option value="">--Select--</option>
										<option value="High priority">High</option>
										<option value="Mediam priority">Medium </option>
                               ...
                               <div class="block-input ">
								...
								<label>Select day</label> 
									<select	id="dayId" class="some-select" multiple="multiple">
										<option value="">--Select--</option>
								 ...
								 <div class="block-input ">
									<label>Start Date</label> <input id="startDateId"  
										maxlength="30" 
										onkeydown="removeBorder(this.id)" tabindex="7" />
								</div>
								 <div class="block-input ">
									<label>End Date</label> <input id="endDateId"  
										maxlength="30" 
										onkeydown="removeBorder(this.id)" tabindex="7" />
								</div>
