...
function saveUser(){
	...
	function showData(response){
		...
		$.each(response,
				...
				var tblRow = "<ul>"
					+ "<li class='three-box'>"+catObj.vendorName+"</li>"
	...
	<div class="wrapper">
		<div class="container">
				...
				<div class="block">
					<h2>
						<span class="icon1">&nbsp;</span> <a href='javascript:void(0)'
							onclick='addPack()'> Vendor Details</a>
					...
					<!-- End Box Head -->
						...
						<div
							...
							<form:form action="" commandName="trancationCmd" method="post">
							<div class="block-input ">
							<label>Vendor Name:</label>
											 <form:select path="vendorId" id="accholderName"   cssClass="some-select"   tabindex="2">
			...
			<div class="block table-toop-space">
				<div class="head-box">
					<h2>
						<span class="icon2">&nbsp;</span>Vendor Bank Details
					</h2>
