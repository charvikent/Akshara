	...
	$(document).ready(function() {
						...
						//AddForm Validations
								 ...
								 $('#submitId').click(function(e){
											...
											$('#addForm').attr('action',"<c:url value='/pathologyInventoryAdd1.htm'/>");
											$("#addForm").submit();											
	...
	<div class="wrapper">
		<div class="container">
			<div class="main_content">
				<c:if test="${empty catEdit}">
					<div class="block">
						...
						<!-- End Box Head -->
						<form:form action="pathologyInventoryAdd1.htm" commandName="pathologyInventoryCmd1" method="post"
			...
			<div class="block">
				...
				<form:form action="" commandName="pathologyInventoryCmd1" method="post"
			...
			<div class="block table-toop-space">
				<div class="head-box">
					...
					<form:form action="searchCat.htm" commandName="pathologyInventoryCmd1" method="get">
