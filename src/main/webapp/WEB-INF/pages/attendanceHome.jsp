										...
										<div class="table-responsive">
											...
											<br><br>
												...
												<div class="form-group">
											    	...
											    	<div class="col-lg-6 col-md-6 col-sm-8 col-xs-8">
														<textarea id="messageId" class="form-control" style="margin: 0px;height: 75px;" required>Dear #2, your child #1 is absent today. Please send your child regularly.</textarea>
