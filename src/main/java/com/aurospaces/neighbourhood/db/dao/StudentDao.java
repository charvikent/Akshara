...
public class StudentDao  extends BaseStudentDao{
	 public List<Map<String, String>> getallStudentDetails(String boardName,String medium,String className,String section,String email,	String caste,String admissionNum,String studentName){
		 StringBuffer objStringBuffer = new StringBuffer();
		 objStringBuffer.append("select distinct(s.id ) as studentId, Date(s.dob) as dob ,s.name as studentName,bn.name as boardName,m.name as mediumName,s.rollNum,s.admissionNum, "
		...
		if (StringUtils.isNotBlank(email)) {
			objStringBuffer.append("  and  s.email  LIKE '%"+ email +"%'" );
		}
